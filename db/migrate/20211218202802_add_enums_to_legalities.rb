class AddEnumsToLegalities < ActiveRecord::Migration[6.1]
  def up
    execute <<-SQL
  ...
  def down
    change_column :legalities, :format, :string # Previous type
    change_column :legalities, :status, :string # Previous type
  end
end
