...
ActiveRecord::Schema.define(version: 2021_12_21_033821) do
  ...
  create_table "card_foreign_data", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.text "cardType"
    t.text "flavorText"
  ...
  create_table "card_legalities", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "card_rulings", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.date "date"
    t.text "text"
    t.string "uuid", limit: 36, default: "", null: false
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "card_set_translations", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "card_sets", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
